...
#  teaching unit ITD104 "Building IT Systems".  You should put
...
#  the marker will use their own copy of the file.  If your program
...
def create_drawing_canvas(canvas_title = "Put your solution's title here",
    ...
    if draw_grid:
        ...
        # Mark the home cell (assuming a grid
...
def release_drawing_canvas(signature,
    ...
    # Ensure any student drawing still in progress is displayed completely
    tracer(True)
